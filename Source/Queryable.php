...
class Queryable implements IQueryable, IOrderedTraversable, IGroupedTraversable
{
     ...
     * @return IQueryable
     */
    protected final function newSegment(Queries\ISegment $segment)
    {
     ...
     * @return IQueryable
     */
    protected final function updateLastSegment(Queries\ISegment $segment)
    {
    ...
    protected final function convert(callable $function = null)
    {
